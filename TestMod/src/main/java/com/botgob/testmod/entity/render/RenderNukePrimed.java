package com.botgob.testmod.entity.render;
...
public class RenderNukePrimed extends Render<EntityNukePrimed>{
	...
	public static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MOD_ID + "textures/blocks/nuke_block.png");
